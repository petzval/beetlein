...
int onEvent(int event,int device,int handle,int member,char *text)
  ...
  if(event == SERVER_START)
    ...
    btle_image_line(device,image[device],5,50,40,50,1,0,0,0);
    ...
    btle_image_text(device,image[device],"3 pixels",120,30,DIRN_HORIZ,FONT_DEFAULT,16,0,0,0);
    btle_image_line(device,image[device],105,50,140,50,3,0,0,0);
    btle_image_arc(device,image[device],145,50,195,100,50,CLOCK_SHORT,3,255,0,0);
